<?php
    ...
    if(isset($_POST['simpan'])){
        extract($_POST);
        $insert = mysqli_query($conn,"insert into siswa values(null,'$nis','$nisn','$nama','$alamat','$hp','$agama','$jk')");
        if($insert){
            ?>
                <script>
...
<body>
    ...
    <form action="?hal=tambah" method="post">
        <table>
            ...
            <tr>
                <td>Nama Siswa</td>
                <td><input type="text" name="nama" placeholder="Nomor Siswa" maxlength="50"></td>
            </tr>
            <tr>
                <td>Alamat</td>
